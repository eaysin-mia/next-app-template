  ...
  return (
    ...
    >
      <SearchField
        ...
        className="w-full"
      >
        <SearchField.Group className="relative flex items-center w-full h-[54px] sm:h-[56px] bg-surface rounded-full border border-border shadow-sm hover:border-foreground/20 focus-within:border-foreground/30 focus-within:shadow-md transition-all duration-200 pl-3 pr-2">
